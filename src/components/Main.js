    ...
    return (
		...
		<section className="profile">
			<div className="profile__container">
				<img style={{ backgroundImage: `url(${currectUser.avatar})`, backgroundPosition: 'center',
                backgroundRepeat: 'no-repeat', backgroundSize: 'cover'}} alt="" className="profile__avatar" />
